...
BoxEdge::BoxEdge(
	...
	int slices, int segments) : translateMesh_{
...
BoxEdges::BoxEdges(
	...
	int slices, int segments) : mirrorMesh_{
...
BoxCorner::BoxCorner(
	const gml::dvec3 &position, double radius, int slices) : translateMesh_{
...
BoxCorners::BoxCorners(const gml::dvec3 &size, double radius, int slices) : mirrorMesh_{{{{size, radius, slices}, Axis::X}, Axis::Y}, Axis::Z}
{
}
...
RoundedBoxMesh::RoundedBoxMesh(
	...
	int slices,
	const gml::ivec3 &segments) : mergeMesh_{
