...
SvgWriter::BaseElem::BaseElem(double z, const gml::dvec3 &color) : z_{z},
																   color_{color}
{
}
...
SvgWriter::VertexElem::VertexElem(const gml::dvec3 &p, const gml::dvec3 &color) : BaseElem{p[2], color},
																				  p_{p}
{
}
...
SvgWriter::LineElem::LineElem(
	const gml::dvec3 &p1, const gml::dvec3 &p2, const gml::dvec3 &color) : BaseElem{(p1[2] + p2[2]) / 2.0, color},
																		   p1_(p1),
																		   p2_(p2)
{
}
...
SvgWriter::TriangleElem::TriangleElem(
	...
	const gml::dvec3 &color) : BaseElem{(p1[2] + p2[2] + p3[2]) / 3.0, color},
							   p_{{p1, p2, p3}}
{
}
...
SvgWriter::SvgWriter(int width, int height) : size_{width, height},
											  viewMatrix_{1.0},
											  projMatrix_{1.0},
											  viewProjMatrix_{1.0},
											  viewportOrigin_{0, 0},
