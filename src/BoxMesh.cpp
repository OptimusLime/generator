...
BoxFace::BoxFace(
	const gml::dvec2 &size, const gml::ivec2 &segments, double delta) : translateMesh_{{size, segments}, {0.0, 0.0, delta}}
{
}

BoxFaces::BoxFaces(
	const gml::dvec2 &size, const gml::ivec2 &segments, double delta) : mergeMesh_{
																			{size, segments, delta},
