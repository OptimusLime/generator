...
IcosahedronMesh::Triangles::Triangles(const IcosahedronMesh &mesh) : mesh_{&mesh},
																	 i_{0},
...
IcosahedronMesh::Vertices::Vertices(const IcosahedronMesh &mesh) : mesh_{&mesh},
																   i_{0},
																   triangleMesh_{std::make_shared<TriangleMesh>(
																	   ::vertices[::triangles[0][0]],
																	   ::vertices[::triangles[0][1]],
...
IcosahedronMesh::IcosahedronMesh(double radius, int segments) : radius_{radius},
																segments_{segments},
