...
SphericalTriangleMesh::Triangles::Triangles(const SphericalTriangleMesh &mesh) : mesh_{&mesh},
																				 row_{0},
																				 col_{0},
																				 i_{0}
{
...
SphericalTriangleMesh::Vertices::Vertices(const SphericalTriangleMesh &mesh) : mesh_{&mesh},
																			   row_{0},
																			   col_{0}
{
}
...
SphericalTriangleMesh::SphericalTriangleMesh(
	double radius,
	int segments) : SphericalTriangleMesh{
