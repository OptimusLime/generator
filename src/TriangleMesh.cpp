...
TriangleMesh::Triangles::Triangles(const TriangleMesh &mesh) : mesh_{&mesh},
															   row_{0},
															   col_{0},
															   i_{0}
{
...
TriangleMesh::Vertices::Vertices(const TriangleMesh &mesh) : mesh_{&mesh},
															 row_{0},
															 col_{0}
{
}
...
TriangleMesh::TriangleMesh(double radius, int segments) : TriangleMesh{
