...
namespace shape_generator
{
	...
	private:
		...
		explicit BezierMesh(
			const ArrayWrapper &p, const gml::ivec2 &segments) : mParametricMesh{
																	 [p](const gml::dvec2 &t) {
																		 MeshVertex vertex;
	...
	public:
		...
		explicit BezierMesh(
			const gml::dvec3 (&p)[D1][D0], const gml::ivec2 &segments = {16, 16}) : // Work around a msvc lambda capture bug by wrapping the array.
