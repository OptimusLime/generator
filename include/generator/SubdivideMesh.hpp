...
namespace shape_generator
{
	...
	public:
		SubdivideMesh(Mesh mesh) : subdivideMesh_{
	...
	public:
		SubdivideMesh(Mesh mesh) : mesh_{std::move(mesh)}
		{
		}
	...
	public:
		...
		private:
			...
			Triangles(const SubdivideMesh &mesh) : mesh_{&mesh},
												   i_{0},
		...
		private:
			...
			Vertices(const SubdivideMesh &mesh) : mesh_{&mesh},
												  edgeIndex_{0},
												  vertexIndex_{0}
			{
			}
